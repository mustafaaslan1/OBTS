        ...
        public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var ekBilgi = new KullaniciEkBilgi
                    {
                        UserId = user.Id,
                        IsApproved = false,
                    ...
                    else
                    {
                        ...
                        TempData["KayitBasarili"] = "Kayıt talebiniz başarıyla alındı. Yöneticiniz hesabınızı onayladıktan ve rolünüzü belirledikten sonra sisteme giriş yapabilirsiniz.";
